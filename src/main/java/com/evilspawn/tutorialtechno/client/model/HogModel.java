package com.evilspawn.tutorialtechno.client.model;
...
public class HogModel<T extends HogEntity> extends EntityModel<T> {
    ...
    public HogModel() {
        ...
        head.setTextureOffset(28, 0).addBox(-2.0F, 0.0F, -9.0F, 4.0F, 3.0F, 1.0F, 0.0F, false);

        legBackLeft = new ModelRenderer(this);
        legBackLeft.setRotationPoint(3.0F, 18.0F, 7.0F);
        legBackLeft.setTextureOffset(36, 10).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);

        legBackRight = new ModelRenderer(this);
        legBackRight.setRotationPoint(-3.0F, 18.0F, 7.0F);
        legBackRight.setTextureOffset(36, 0).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);

        legFrontLeft = new ModelRenderer(this);
        legFrontLeft.setRotationPoint(3.0F, 18.0F, -5.0F);
        legFrontLeft.setTextureOffset(32, 20).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);

        legFrontRight = new ModelRenderer(this);
        legFrontRight.setRotationPoint(-3.0F, 18.0F, -5.0F);
        legFrontRight.setTextureOffset(32, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
    }
